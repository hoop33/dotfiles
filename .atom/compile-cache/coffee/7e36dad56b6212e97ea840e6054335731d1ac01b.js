  ...
  describe("Operators", function() {
    ...
    describe("the A keybinding", function() {
      ...
      return describe("at the beginning of a line", function() {
        return it("switches to insert mode at the end of the line", function() {
          editor.setCursorScreenPosition([0, 0]);
          keydown('A', {
            shift: true
          });
    ...
    describe("the I keybinding", function() {
      ...
      return describe("at the end of a line", function() {
        ...
        return it("switches to insert mode after leading whitespace", function() {
          editor.setCursorScreenPosition([1, 4]);
          keydown('I', {
            shift: true
          });
    ...
    describe("the i keybinding", function() {
      ...
      return it("allows repeating typing", function() {
        ...
        keydown('escape');
        keydown('.');
        return editor.insertText("ababcc");
      });
    });
    return describe('the a keybinding', function() {
      ...
      return it("repeats correctly", function() {
        ...
        expect(editor.getText()).toBe("abc");
        keydown('.');
        return expect(editor.getText()).toBe("abcabc");
      });
    });
  });
