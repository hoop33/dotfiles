    ...
    return {
      ...
      activate: function() {
        ...
        colorPicker.onOpen((function(_this) {
          return function() {
            return _this.element.rect = _this.element.el.getClientRects()[0];
          };
        })(this));
        setTimeout((function(_this) {
          return function() {
            ...
            _elementWidth = _this.element.width();
            _elementHeight = _this.element.height();
            _this.canvas = {
              el: (function() {
                var _el;
              ...
              render: function(smartColor) {
                var _context, _gradient, _rgb, _rgbFragmentString;
                _rgb = (function() {
                  if (!smartColor) {
                    return (colorPicker.SmartColor.HEX('#ff0000')).toRGBArray();
                  } else {
                    return smartColor.toRGBArray();
                  }
                })();
