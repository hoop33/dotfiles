(function() {
  module.exports = function() {
    var findDefinition, path, _definitions, _globPatterns, _variablePattern;
    path = require('path');
    _definitions = {};
    ...
    return findDefinition = function(name, type) {
      var _definition, _options, _pointer, _regex, _results;
      if (!(name && type)) {
        return;
      }
      ...
      return atom.workspace.scan(_regex, _options, function(result) {
