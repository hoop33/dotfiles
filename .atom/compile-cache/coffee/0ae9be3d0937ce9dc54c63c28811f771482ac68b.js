    ...
    return {
      ...
      activate: function() {
        ...
        this.element = {
          ...
          rect: null,
          getRect: function() {
            return this.rect || (this.rect = this.el.getClientRects()[0]);
          },
        ...
        colorPicker.onOpen((function(_this) {
          return function() {
            if (!(_this.element.rect = _this.element.el.getClientRects()[0])) {
              return;
            }
            _this.width = _this.element.rect.width;
            return _this.height = _this.element.rect.height;
          };
        })(this));
        ...
        setTimeout((function(_this) {
          return function() {
            ...
            colorPicker.onInputColor(function(smartColor) {
              ...
              return _this.control.setSelection(null, (_this.element.getHeight() / 360) * _hue, true);
            });
            Hue.onSelectionChanged(function() {
              return Hue.emitColorChanged();
            });
            colorPicker.onOpen(function() {
              return _this.control.refreshSelection(true);
            });
            colorPicker.onOpen(function() {
