(function() {
  var AllWhitespace, Range, SelectAParagraph, SelectAWord, SelectInsideBrackets, SelectInsideParagraph, SelectInsideQuotes, SelectInsideWord, TextObject,
  ...
  SelectInsideParagraph = (function(_super) {
    ...
    function SelectInsideParagraph(editor, inclusive) {
      this.editor = editor;
      this.inclusive = inclusive;
    }

    SelectInsideParagraph.prototype.select = function() {
  ...
  SelectAParagraph = (function(_super) {
    ...
    function SelectAParagraph(editor, inclusive) {
      this.editor = editor;
      this.inclusive = inclusive;
    }

    SelectAParagraph.prototype.select = function() {
      var range, selection, _i, _len, _ref, _results;
      _ref = this.editor.getSelections();
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
